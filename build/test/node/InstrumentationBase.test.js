    ...
    describe('_onRequire - core module', () => {
        ...
        describe('AND module is not enabled', () => {
            it('should not patch the module', () => {
                ...
                // @ts-expect-error access internal property for testing
                instrumentation._onRequire(instrumentationModule, moduleExports, CORE_MODULE, undefined);
        ...
        describe('when patching a module', () => {
            describe('AND there is no wildcard supported version', () => {
                it('should not patch module', () => {
                    ...
                    // @ts-expect-error access internal property for testing
                    instrumentation._onRequire(instrumentationModule, moduleExports, MODULE_NAME, MODULE_DIR);
...
//# sourceMappingURL=InstrumentationBase.test.js.map